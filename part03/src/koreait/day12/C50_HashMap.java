...
public class C50_HashMap {
	...
	public static void main(String[] args) {
			...
			System.out.println("'샐러드'의 가격 ? " + menus.get("샐러드"));
			
			//key 값 중복되면?
			menus.put("샐러드", 8200);		//실행결과? -> 값이 새로 덮어쓰임(value가 수정됨)
			System.out.println(menus);
	...
	//		menus.remove("샐러드", 6000);		//인자가 key, value : key와 value가 모두 일치해야 삭제됨
			menus.remove("샐러드", 8200);		//인자가 key, value : key와 value가 모두 일치해야 삭제됨
			System.out.println("삭제 결과 확인 : " + menus);
		}

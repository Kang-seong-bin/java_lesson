...
public class C53_InterfaceTest {
	...
	public static void main(String[] args) {
		...
		InterfaceA x2 = new MyClassX();//MyClassx,y,z모두 인터페이스의 구현체임
		InterfaceB y2 = new MyClassY();//모두 인터페이스의 구현체임
		InterfaceA z2 = new MyClassZ();//모두 인터페이스의 구현체임
		InterfaceB z3 = new MyClassZ();//모두 인터페이스의 구현체임
...
//				ㄴ	MyClassZ는 Interface A 와 InterfaceB 타입으로 모두 참조할 수 있는 구현체

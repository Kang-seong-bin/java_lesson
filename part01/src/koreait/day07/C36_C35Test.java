...
//C35 클래스를 1) 객체로 만들어서 2)static 인 것들 테스트합니다.
	// (참고 : main메소드를 갖는 클래스를 객체로 만들지 않는 것이 일반적입니다.
	public static void main(String[] args) {
		...
		//C35클래스에서 static이 아닌 인스턴스 변수에는 객체마다 다른 값을 저장합니다. -객체 각각 다른특성을 나타냅니다.
		test1.count = 10;
		test2.count = 20;
		...
		System.out.println("static num = " + test2.num);			//경고: static 방법으로 사용해라
		...
		//C35_GlobalVar.TEST =100;			//오류 : final은 값 변경 못합니다.대입문자체가 안됨 즉 똑같은 값을 줘도 오류
		
		C35_GlobalVar test3 = new C35_GlobalVar();
		// 전역 변수의 기본 초기값-0, 0.0   참조 타입은 null
		//참고 : 지역변수의 기본 초기값 배열일 때만 0, 0.0   참조 타입은 null, 나머지는 오류

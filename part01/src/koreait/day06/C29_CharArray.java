...
//char 배열의 특징 및 문자열과의 연관된 내용 파악하기!
	...
	public static void main(String[] args) {
		...
		System.out.println("carr2 : " + Arrays.toString(carr2));	//값 0에 대한 문자는 빈 칸
		...
		System.out.println("carr2 배열 3번째 데이터의 값(문자) : " + carr2[2]);//값?빈칸
		// int형으로 형변환해서 출력하면 정수값이 나온다.
		...
		//"hello hi goodbye"; // char배열에 바로 문자열 대입은 오류
		...
		System.out.println(carr2);
		System.out.println("carr2.length : " + carr2.length);	//27. 배열의크기가 커집니다	

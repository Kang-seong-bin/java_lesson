...
*/
		...
		if(animal instanceof Cat) {
		 cat = (Cat)animal;	//다운 캐스팅: animal 진짜 객체에 따라 오류가 생길 수도 있으며 안생길 수도 있다. -> instanceof 조건식 필요
		 cat.sound();
		}
...
class Frog extends Animal{//개구리
	...
	protected String mouth; //디폴트 한정자 + 다른 패키지 자식
...
System.out.println("특징 : 점핑");
	...
	//다형성 구현: 메소드 오버라이드			*참고 : 오버로딩(overloading) _ 각자 찾아보기

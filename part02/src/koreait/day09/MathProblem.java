...
public class MathProblem {
	...
	/* 참고
	 * static 메소드는 인스턴스 필드값과는 무관(객체와 연관된 동작이 아니다.)하게 동작하는 메소드
	...
	public void makeProb() { // 사칙연산 종류별로 적절한 난수 생성하기->문제를 만들어 줍니다.
		...
		case '-':		//op 값이 '-' 일 때
			...
			break;
		case '*':		//op 값이 '*' 일 때
			max1=77;max2=29;min1=11;min2=11;		//n1은 11~77 , n2는 11~29 : n1>n2 곱셈과정을 고려해서 n2를 작게
			break;
		case '/':		//op 값이 '/' 일 때
			max1=99;max2=29;min1=41;min2=11;		//n1은 41~99 , n2는 11~29 : n1>n2 나눗셈과정을 고려해서 n1을 좀더 크게
			break;
